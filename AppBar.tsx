...
const AppBar: React.FC<AppBarProps> = ({ onViewChange, onRefresh, currentView }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-20 bg-black/80 backdrop-blur-3xl z-[200] border-b border-white/5 px-4 flex items-center justify-between shadow-[0_15px_50px_rgba(0,0,0,0.9)]">
